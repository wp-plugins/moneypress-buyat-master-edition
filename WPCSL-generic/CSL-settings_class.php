...
class wpCSL_settings {
  ...
  function add_section($params) {
    $this->sections[$params['name']] = new wpCSL_settings_section(array_merge($params, array('plugin_url' => $this->plugin_url)));
  }
   ...
   *    display name
   *    type (default: text)
   *    required setting? (default: false)
  ...
  function show_product_settings() {
    ...
    if (get_option($this->prefix.'-purchased')) {
      ...
      $content .= '<span><img src="'. $this->plugin_url .'/images/check_green.png" border="0" style="padding-left: 5px;" alt="License validated!" title="License validated!"></span>';
    }
...
<div>
  <p>Your license key is emailed to you within 15 minutes of your purchase.
  If you did not receive your license check your spam folder.
  <a href='http://www.cybersprocket.com/contact-us/' target='cyber sprocket'>Contact us if you need your license sent again.</a></p>
</div>
";
    }
...
class wpCSL_settings_section {
  ...
  function add_item($params) {
          $this->items[] = new wpCSL_settings_item(array_merge($params, array('plugin_url' => $this->plugin_url)));
  }
...
class wpCSL_settings_item {
  ...
  function display_description($content) {
    ...
    echo '<img src="'.$this->plugin_url.'/images/expand_down.png" border="0" style="padding-left: 5px; position: relative; top: 4px;" alt="More info" title="More info"></a>';
